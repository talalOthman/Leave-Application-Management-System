                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header clearfix">
                            <h2 class="pull-left text-white display-5 m-4 ">Leaves taken by this staff</h2>
                            
                            <form method="POST">
                                <input type="submit" name="ASC" class="btn btn-info mr-5 mb-3" value="ASCENDING ORDER">
